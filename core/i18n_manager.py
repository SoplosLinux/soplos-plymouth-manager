"""
Internationalization (i18n) manager for Soplos Plymouth Manager.
...
class I18nManager:
    ...
    def __init__(self, locale_dir: str, domain: str = 'soplos-plymouth-manager'):
        """
    ...
    def detect_system_language(self) -> str:
        ...
        env_vars = ['SOPLOS_PLYMOUTH_MANAGER_LANG', 'LANGUAGE', 'LC_ALL', 'LC_MESSAGES', 'LANG']
    ...
    def get_translation(self, message: str, **kwargs) -> str:
        ...
        # Treat empty translation as missing
        if not translated:
            translated = message
        ...
        # Treat empty fallback translation as missing
        if not translated:
            translated = message
    ...
    def create_pot_template(self, source_files: List[str], output_file: str):
        ...
        try:
            ...
            cmd = [
                ...
                '--package-name=soplos-plymouth-manager',
...
def get_i18n_manager(locale_dir: str = None, domain: str = 'soplos-plymouth-manager') -> I18nManager:
    """
...
def initialize_i18n(locale_dir: str = None, domain: str = 'soplos-plymouth-manager') -> str:
    """
